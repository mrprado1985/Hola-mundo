...
function loadEmployee() {
	  ...
	  xhttp.open("post", "/Project1/viewEmployee.do");
	  xhttp.send();
	}
...
function loadAllPendingRequests() {
	  ...
	  xhttp.open("post", "/Project1/employeePendingRequests.do");
	  xhttp.send();
	}
...
function loadAllResolvedRequests() {
	  ...
	  xhttp.open("post", "/Project1/employeeResolvedRequests.do");
	  xhttp.send();
	}
...
function loadSearch() {
	  ...
	  xhttp.open("post", "/Project1/searchEmployee.do");
	  xhttp.send();
	}
